...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (logoutButton) {
        logoutButton.addEventListener("click", function() {
            fetch("http://localhost/Dashboard/logout.php", {
                method: "POST",
                headers: {
            ...
            .then(data => {
                if (data.message === "Logout successful") {
                    console.log("Logout was successful:", data.message);
                    // Clear local storage and session storage, then redirect to login
                    localStorage.clear();
                    sessionStorage.clear();
                    window.location.href = "login.html";
                } else {
                    console.error("Unexpected response from logout.php:", data);
                }
            })
            .catch(error => {
